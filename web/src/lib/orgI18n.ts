...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'account.profile': { fr: 'Mon profil', ar: 'ملفي الشخصي' },
  'account.save': { fr: 'Enregistrer', ar: 'حفظ' },
  'account.saved': { fr: 'Profil mis à jour — synchronisé', ar: 'تم تحديث الملف — متزامن' },
  'account.password_updated': { fr: 'Mot de passe modifié', ar: 'تم تغيير كلمة السر' },
  'account.current_password': { fr: 'Mot de passe actuel', ar: 'كلمة السر الحالية' },
  'account.new_password_hint': { fr: 'Nouveau mot de passe (12+ car.)', ar: 'كلمة السر الجديدة (12+ حرف)' },
  'account.confirm_password': { fr: 'Confirmer le nouveau', ar: 'تأكيد الجديدة' },
  ...
  // Échéances fiscales (alertes dates)
  'alerts.title': { fr: 'Échéances fiscales', ar: 'المواعيد النهائية' },
  'alerts.add': { fr: 'Échéance', ar: 'موعد نهائي' },
  'alerts.new_title': { fr: 'Nouvelle échéance', ar: 'موعد نهائي جديد' },
  'alerts.empty': { fr: 'Aucune échéance à venir', ar: 'لا مواعيد قادمة' },
  ...
  'alerts.soon': { fr: 'À préparer', ar: 'يجب التحضير' },
  'alerts.days_left': { fr: 'J-{n}', ar: 'ب-{n} يوم' },
  'alerts.days_late': { fr: 'Retard de {n} j', ar: 'تأخر {n} يوم' },
  'alerts.delete_confirm': { fr: 'Supprimer cette échéance ?', ar: 'حذف هذا الموعد النهائي؟' },
  'alerts.mark_done': { fr: 'Marquer traité', ar: 'تحديد كمعالج' },
  'alerts.reopen': { fr: 'Rouvrir', ar: 'إعادة فتح' },
  'alerts.task_badge': { fr: 'Tâche', ar: 'مهمة' },
