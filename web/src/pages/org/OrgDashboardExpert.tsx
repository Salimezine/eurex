    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { label: 'Pas fait', value: blockedCount, icon: '🔴', color: 'red' },
                  ...
                  <div className="flex items-center gap-3 mt-3 text-xs">
                    ...
                    {c.task_stats.bloque_client > 0 && (
                      <span className="bg-red-50 text-red-600 px-2 py-1 rounded-lg font-medium animate-pulse">
                        🔴 {c.task_stats.bloque_client} pas fait{c.task_stats.bloque_client > 1 ? 's' : ''}
                      </span>
                    )}
                  </div>
                </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100 bg-gray-50/50">
                  ...
                  <th className="text-center px-5 py-3.5 font-semibold text-gray-600">Pas fait</th>
                </tr>
              </thead>
              <tbody>
