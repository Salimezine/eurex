    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-2">
        {[
          ...
          { label: 'Bloqué client', value: kpis.blocked_tasks, color: 'red' },
            ...
            <div key={d.id} className="bg-white border border-gray-200 rounded-xl p-4 flex items-center gap-4 cursor-pointer hover:bg-gray-50 transition-colors" onClick={() => navigate(`/cabinet/dossier/${d.id}`)}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex gap-3 mt-1 text-[11px] text-gray-500">
                  ...
                  {d.task_stats.bloque_client > 0 && <span className="text-red-500">✕ {d.task_stats.bloque_client} bloqué{d.task_stats.bloque_client > 1 ? 's' : ''} client</span>}
